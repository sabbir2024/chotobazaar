...
export default function Card({ product }) {
    ...
    const renderRatingStars = (rating) => {
        ...
        for (let i = 0; i < fullStars; i++) {
            stars.push(
                <svg key={`full-${i}`} xmlns="http://www.w3.org/2000/svg" className="h-3 w-3 sm:h-4 sm:w-4 fill-primary text-primary" viewBox="0 0 20 20" fill="currentColor">
        ...
        if (hasHalfStar) {
            stars.push(
                <svg key="half" xmlns="http://www.w3.org/2000/svg" className="h-3 w-3 sm:h-4 sm:w-4 text-primary" viewBox="0 0 20 20" fill="currentColor">
                    <defs>
