...
export default function Mycard({ bookings }) {
    ...
    const getDeliveryZone = (charge) => {
        const zones = {
            ...
            150: { name: 'সাধারণ জেলা', icon: '🚚', color: 'text-primary bg-orange-50 dark:text-primary dark:bg-orange-950/30' }
        };
                ...
                <div class="text-left text-sm max-h-96 overflow-y-auto">
                    <div class="bg-orange-50 dark:bg-orange-950/30 p-3 rounded-lg mb-3">
                        <div class="grid grid-cols-2 gap-2">
                            <span class="font-semibold text-primary dark:text-primary">অর্ডার আইডি:</span>
                    ...
                    <div class="bg-gray-50 dark:bg-gray-800 p-2 rounded-lg my-2">
                        <div class="font-semibold text-primary dark:text-primary mb-1">📦 পণ্যের বিবরণ</div>
                    ...
                    <div class="bg-orange-50 dark:bg-orange-950/30 p-2 rounded-lg my-2">
                        ...
                        <div class="flex justify-between font-bold text-primary dark:text-primary">
                            <span>মোট মূল্য:</span>
        ...
        return (
            <div className="min-h-[60vh] flex items-center justify-center p-4">
                <div className="text-center bg-linear-to-br from-white to-orange-50/30 dark:from-zinc-800 dark:to-orange-950/20 p-6 md:p-10 rounded-2xl shadow-xl w-full max-w-md border border-orange-100 dark:border-orange-900/50">
                    <div className="w-20 h-20 mx-auto bg-linear-to-r from-primary to-primary rounded-full flex items-center justify-center mb-4 shadow-lg">
                    ...
                    <button
                        className="px-6 py-3 bg-linear-to-r from-primary to-primary text-white rounded-xl font-semibold hover:shadow-lg transition-all hover:scale-105"
                        onClick={() => router.push('/')}
                    >
                        শপিং শুরু করুন
                    </button>
    ...
    return (
        <div className="space-y-4 p-2 md:p-0">
            {/* Header & Controls */}
            <div className="bg-linear-to-r from-primary to-primary rounded-2xl p-4 md:p-6 text-white shadow-xl">
                            ...
                            <div className="p-4">
                                ...
                                <div className="flex justify-between items-start mb-3">
                                    <div className="flex items-center gap-2">
                                        ...
                                        />
                                        <span className="font-bold text-primary dark:text-primary bg-orange-50 dark:bg-orange-950/50 px-2 py-1 rounded-lg text-sm">
                                            #{index + 1}
                                        </span>
                                    </div>
                                ...
                                <div className="bg-orange-50 dark:bg-orange-950/30 rounded-xl p-3 mb-3">
                                    ...
                                    <div className="flex justify-between items-center mt-2 text-sm">
                                        <span className="dark:text-gray-300">পরিমাণ: <span className="font-bold text-primary dark:text-primary">{booking.quantity}</span></span>
                                ...
                                <div className="flex justify-between items-center mb-3">
                                    ...
                                    <div className="text-right">
                                        ...
                                        <div className="text-xl font-bold text-primary dark:text-primary">৳{booking.total_price}</div>
                                    </div>
                                </div>
                                ...
                                <div className="flex justify-between items-center pt-3 border-t border-gray-100 dark:border-gray-700">
                                    ...
                                    <div className="flex gap-2">
                                        <button
                                            className="px-3 py-1.5 text-xs font-medium text-primary dark:text-primary bg-orange-50 dark:bg-orange-950/30 rounded-lg hover:bg-orange-100 dark:hover:bg-orange-950/50 transition-colors flex items-center gap-1"
                        ...
                        <tbody>
                            {sortedBookings.map((booking, index) => (
                                <tr key={booking._id} className="hover:bg-orange-50/50 dark:hover:bg-orange-950/20 transition-colors">
                                    ...
                                    <td className="font-bold text-primary dark:text-primary">#{index + 1}</td>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        <div className="text-xs text-primary dark:text-primary">{booking.product_price}</div>
                                    </td>
                                    <td>
                                        <span className="inline-flex items-center justify-center w-8 h-8 bg-orange-100 dark:bg-orange-950/50 text-primary dark:text-primary rounded-full font-bold text-sm">
                                            {booking.quantity}
                                        </span>
                                    </td>
                                    <td>
                                        <div className="font-bold text-primary dark:text-primary">৳{booking.total_price}</div>
                                    ...
                                    <td>
                                        <div className="flex gap-1">
                                            <button
                                                className="p-2 text-primary dark:text-primary hover:bg-orange-50 dark:hover:bg-orange-950/30 rounded-lg transition-colors"
                                                title="বিস্তারিত"
                                                onClick={() => showOrderDetails(booking)}
                                            >
                                                <IoEyeOutline />
            ...
            <div className="bg-linear-to-r from-orange-50 to-orange-100/30 dark:from-orange-950/30 dark:to-orange-900/20 rounded-2xl p-4 border border-orange-100 dark:border-orange-900/50">
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
                    ...
                    <div className="flex items-center gap-4 text-xs text-gray-500 dark:text-gray-400">
                        ...
                        <span className="flex items-center gap-1"><IoRocketOutline className="text-primary" /> প্রসেসিং: {bookings.filter(b => b.order_status === 'processing').length}</span>
                    </div>
                </div>
            </div>
        </div>
