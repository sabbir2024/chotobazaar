...
export default function ProductInfoTabs({ product }) {
    ...
    const getProcessedDescription = () => {
        ...
        processedDesc = processedDesc.replace(/<a/g, '<a class="text-primary dark:text-primary hover:underline"');
    ...
    return (
        <div className="card w-full bg-white/80 dark:bg-zinc-800/80 shadow-2xl rounded-3xl overflow-hidden backdrop-blur-lg border border-white/40 dark:border-zinc-700/60 transition-all duration-300 hover:scale-[1.01] hover:shadow-3xl relative">
            <div className="card-body p-4 sm:p-6">
                ...
                {/* Category Badge */}
                <p className="text-primary dark:text-primary text-xs sm:text-sm font-bold tracking-wider uppercase">
                    {getCategory()}
                </p>
                ...
                <div className="flex items-center gap-3 flex-wrap">
                    <span className="text-2xl sm:text-3xl font-black text-primary dark:text-primary">
                    ...
                    {product.discount > 0 && (
                        <span className="bg-primary dark:bg-primary text-white text-xs px-2 py-1 rounded-full font-bold">
                            -{product.discount}%
                        </span>
                    )}
                </div>
                ...
                <div className="flex flex-col sm:flex-row gap-3 mt-6 relative z-10">
                    ...
                    <button className="flex-1 py-3 rounded-xl border-2 border-primary dark:border-primary text-primary dark:text-primary font-bold uppercase tracking-wider text-sm hover:bg-primary dark:hover:bg-primary hover:text-white transition-all duration-200 flex items-center justify-center gap-2">
